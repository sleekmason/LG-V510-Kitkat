...
#define WPS_MS_ID_VPI               0x1001	/*                                 */
#define WPS_MS_ID_TRANSPORT_UUID    0x1002      /*                    */

/*                                             */
#define WPS_MS_VPI_TRANSPORT_NONE   0x00        /*      */
#define WPS_MS_VPI_TRANSPORT_DPWS   0x01        /*                                  */
#define WPS_MS_VPI_TRANSPORT_UPNP   0x02        /*      */
#define WPS_MS_VPI_TRANSPORT_SDNWS  0x03        /*                                         */
#define WPS_MS_VPI_NO_PROFILE_REQ   0x00        /*                             
                                   
       */
#define WPS_MS_VPI_PROFILE_REQ      0x01        /*                           */
...
#define WPS_DEVICE_TYPE_CAT_AUDIO_DEVICES   11	/*         */
...
#define WPS_DEVICE_TYPE_SUB_CAT_COMP_UM_PC      4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_COMP_NOTEBOOK   5	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_COMP_DESKTOP    6	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_COMP_MID        7	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_COMP_NETBOOK    8	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_Keyboard    1	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_MOUSE       2	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_JOYSTICK    3	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_TRACKBALL   4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_GAM_CTRL    5	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_REMOTE      6	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_TOUCHSCREEN 7	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_BIO_READER  8	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_INP_BAR_READER  9	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_PRTR_PRINTER    1
#define WPS_DEVICE_TYPE_SUB_CAT_PRTR_SCANNER    2
#define WPS_DEVICE_TYPE_SUB_CAT_PRTR_FAX        3	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_PRTR_COPIER     4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_PRTR_ALLINONE   5	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_CAM_DGTL_STILL  1
#define WPS_DEVICE_TYPE_SUB_CAT_CAM_VIDEO_CAM   2	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_CAM_WEB_CAM     3	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_CAM_SECU_CAM    4	/*         */
...
#define WPS_DEVICE_TYPE_SUB_CAT_NW_GATEWAY      4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_NW_BRIDGE       5	/*         */
...
#define WPS_DEVICE_TYPE_SUB_CAT_DISP_MONITOR    4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_MM_DAR          1
#define WPS_DEVICE_TYPE_SUB_CAT_MM_PVR          2
#define WPS_DEVICE_TYPE_SUB_CAT_MM_MCX          3
#define WPS_DEVICE_TYPE_SUB_CAT_MM_STB          4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_MM_MS_ME        5	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_MM_PVP          6	/*         */
...
#define WPS_DEVICE_TYPE_SUB_CAT_GAM_GC          4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_GAM_PGD         5	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_PHONE_WM        1
#define WPS_DEVICE_TYPE_SUB_CAT_PHONE_PSM       2	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_PHONE_PDM       3	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_PHONE_SSM       4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_PHONE_SDM       5	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_AUDIO_TUNER     1	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_AUDIO_SPEAKERS  2	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_AUDIO_PMP       3	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_AUDIO_HEADSET   4	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_AUDIO_HPHONE    5	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_AUDIO_MPHONE    6	/*         */
#define WPS_DEVICE_TYPE_SUB_CAT_AUDIO_HTS       7	/*         */
