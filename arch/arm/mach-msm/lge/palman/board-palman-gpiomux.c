...
static struct gpiomux_setting headset_active_cfg = {
...
static struct msm_gpiomux_config apq8064_earjack_configs[] = {
	{
		.gpio = 23,
		.settings = {
			[GPIOMUX_ACTIVE] = &headset_active_cfg
		}
	},
};
#endif
...
#if defined (CONFIG_SLIMPORT_ANX7808)
static struct msm_gpiomux_config apq8064_slimport_configs[] __initdata = {
	{
		.gpio = 32,
		.settings = {
...
#if defined(CONFIG_ANDROID_IRRC)
static struct msm_gpiomux_config apq8064_irrc_tx_configs[] __initdata = {
	{
		.gpio = 34,
		.settings = {
...
static struct gpiomux_setting gpio_gsbi7_i2c_data_config = {
	.func = GPIOMUX_FUNC_2,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting gpio_gsbi7_i2c_config_sus = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_KEEPER,
};

static struct gpiomux_setting gpio_gsbi7_i2c_clk_config = {
	.func = GPIOMUX_FUNC_3,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct msm_gpiomux_config apq8064_gsbi7_i2c_8ma_configs[] __initdata = {
	{
		.gpio      = 85,                //                  
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_gsbi7_i2c_config_sus,
			[GPIOMUX_ACTIVE] = &gpio_gsbi7_i2c_clk_config,
		},
	},
	{
		.gpio      = 84,                //                   
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_gsbi7_i2c_config_sus,
			[GPIOMUX_ACTIVE] = &gpio_gsbi7_i2c_data_config,
		},
	},
};
#endif
