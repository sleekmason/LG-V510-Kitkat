...
static int __init tpa2028d_dual_amp_init(void)
{
	return i2c_add_driver(&tpa2028d_amp_driver);
}


static void __exit tpa2028d_dual_amp_exit(void)
{
	return i2c_del_driver(&tpa2028d_amp_driver);
}


static int __init tpa2028d2_dual_amp_init(void)
{
	return i2c_add_driver(&tpa2028d_amp2_driver);
}


static void __exit tpa2028d2_dual_amp_exit(void)
{
	return i2c_del_driver(&tpa2028d_amp2_driver);
}

module_init(tpa2028d_dual_amp_init);
module_exit(tpa2028d_dual_amp_exit);

module_init(tpa2028d2_dual_amp_init);
