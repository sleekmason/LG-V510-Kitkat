...
//                                                        
uint8_t imx091_Cal_ver; //             
struct msm_calib_ver imx091_Calib_Ver; //             
//                                                      
...
static struct msm_camera_eeprom_read_t imx091_eeprom_read_tbl[] = {
	...
	{0x0C, &imx091_lsc50calib_data[0], 884, 0}, //       
	{0x38A, &imx091_lsc40calib_data[0], 884, 0}, //     
...
static void imx091_format_Cal_ver(void)
{
		...
		imx091_Calib_Ver.cal_ver = (imx091_Cal_ver); //             
}
//                                                      
