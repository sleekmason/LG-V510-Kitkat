...
static struct msm_camera_i2c_reg_conf ov7692_sharpness[][2] = {
	{{0xb4, 0x20, 0x00, 0x00, 0xDF},
		{0xb6, 0x00, 0x00, 0x00, 0xE0},},    /*                  */
	{{0xb4, 0x20, 0x00, 0x00, 0xDF},
		{0xb6, 0x01, 0x00, 0x00, 0xE0},},    /*                  */
	{{0xb4, 0x00, 0x00, 0x00, 0xDF},
		{0xb6, 0x00, 0x00, 0x00, 0xE0},},    /*                  */
	{{0xb4, 0x20, 0x00, 0x00, 0xDF},
		{0xb6, 0x66, 0x00, 0x00, 0xE0},},    /*                  */
	{{0xb4, 0x20, 0x00, 0x00, 0xDF},
		{0xb6, 0x99, 0x00, 0x00, 0xE0},},    /*                  */
	{{0xb4, 0x20, 0x00, 0x00, 0xDF},
		{0xb6, 0xcc, 0x00, 0x00, 0xE0},},    /*                  */
};
...
static struct msm_camera_i2c_reg_conf ov7692_exposure[][3] = {
	{{0x24, 0x50}, {0x25, 0x40}, {0x26, 0xa2},}, /*                      */
	{{0x24, 0x70}, {0x25, 0x60}, {0x26, 0xa2},}, /*                      */
	{{0x24, 0x86}, {0x25, 0x76}, {0x26, 0xb3},}, /*                     */
	{{0x24, 0xa8}, {0x25, 0xa0}, {0x26, 0xc4},}, /*                      */
	{{0x24, 0xc0}, {0x25, 0xb8}, {0x26, 0xe6},}, /*                      */
};
...
static struct msm_camera_i2c_reg_conf ov7692_iso[][1] = {
	{{0x14, 0x20, 0x00, 0x00, 0x8F},},   /*        */
	{{0x14, 0x20, 0x00, 0x00, 0x8F},},   /*          */
	{{0x14, 0x00, 0x00, 0x00, 0x8F},},   /*       */
	{{0x14, 0x10, 0x00, 0x00, 0x8F},},   /*       */
	{{0x14, 0x20, 0x00, 0x00, 0x8F},},   /*       */
	{{0x14, 0x30, 0x00, 0x00, 0x8F},},   /*       */
	{{0x14, 0x40, 0x00, 0x00, 0x8F},},   /*        */
};
...
static struct msm_camera_i2c_reg_conf ov7692_antibanding[][2] = {
	{{0x13, 0x20, 0x00, 0x00, 0xDF},
		{0x14, 0x16, 0x00, 0x00, 0xE8},},   /*                */
	{{0x13, 0x20, 0x00, 0x00, 0xDF},
		{0x14, 0x17, 0x00, 0x00, 0xE8},},   /*                */
	{{0x13, 0x20, 0x00, 0x00, 0xDF},
		{0x14, 0x14, 0x00, 0x00, 0xE8},},   /*                 */
};
